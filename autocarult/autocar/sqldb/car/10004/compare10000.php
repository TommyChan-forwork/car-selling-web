...
<?php   $rows = mysqli_num_rows($result);  
 for ($i = 0; $i < $rows; ++$i){ ?>
						  	...
						  	<div class='col-md-6 text-left'>
							  	<div class='outer'>
								  <h2 style="margin-top:5vh; margin-bottom:5vh;">Benz E500 Cabroiolet</h2>
									  	<div class='upper'>
...
$row = mysqli_fetch_row($result);
			...
			if($issold == true){	
				...
				echo ("<a class="."btn btn-primary btn-lg"." href="."../10004.php"." role="."button".">Buy it</a>");
			}
            else{
				echo ("");
			}
...
$row = mysqli_fetch_row($result);
			...
			$issold=$row['10'];
			$img=$row['13'];
			echo "<img src='../../$img'  width='600' height='280'><br><br> ";	
