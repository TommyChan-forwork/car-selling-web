...
$row = mysqli_fetch_row($result);
			...
			if($issold == true){	
				...
				echo ("<a class="."btn btn-primary btn-lg"." href="."animation/buyacar.php"." role="."button".">Buy it</a>");
			}
            else{
				echo ("");
			}
         ...
         <div class='lower'>
			...
			<i class="fa fa-balance-scale " style="margin-top:200px; margin-left:15vh; font-size:100px" aria-hidden="true" ></i>
<br><br>
<a class="btn btn-primary btn-lg" href="animation/buyacar.php" role="button" style=" margin-left:15vh;">Campare</a>
</div>
            </div>
