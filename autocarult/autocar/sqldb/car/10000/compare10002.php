...
$query3 = "SELECT * FROM  carinventory where id=10000";
...
<?php   $rows = mysqli_num_rows($result);  
 for ($i = 0; $i < $rows; ++$i){ ?>
						  	...
						  	<div class='col-md-6 text-left'>
							  	<div class='outer'>
								  <h2 style="margin-top:5vh; margin-bottom:5vh;">Audi A8L 60 TFSI quattro</h2>
									  	<div class='upper'>
...
$row = mysqli_fetch_row($result);
			...
			if($issold == true){	
				...
				echo ("<a class="."btn btn-primary btn-lg"." href="."../10000.php"." role="."button".">Buy it</a>");
			}
            else{
				echo ("");
			}
         ...
         <div class='lower'>
            ...
            <div class="container">
		        <div class='row'>
					  <div class='col-md-12 text-center'>
                      <h2 style="margin-top:5vh; margin-bottom:5vh;">Audi TT Roadster 1.8T</h2>
                      <div class='row'>
                          <?php

    include '../../connection.php';
$query3 = "SELECT * FROM  carinventory where id=10002"  ;
$result = mysqli_query ($conn, $query3);     
...
$row = mysqli_fetch_row($result);
			...
			$issold=$row['10'];
			$img=$row['13'];
			echo "<img src='../../$img'  width='400' height='300'><br><br> ";	
			...
			if($issold == true){	
				...
				echo ("<a class="."btn btn-primary btn-lg"." href="."../10002.php"." role="."button".">Buy it</a>");
			}
            else{
				echo ("");
			}
