	        ...
	        <div class="container">
		        <div class='row'>
					  <div class='col-md-12 text-left'>
					  	<h3 style = "margin-bottom:15vh;margin-top:5vh;">Certifed Used car</h3>
                          <div class='row'>
                          <?php

    include '../connection.php';
	$query1 = "SELECT * FROM `carinventory` WHERE BrandNew = 'no' ORDER BY `carinventory`.`YearManufactured` DESC "  ;
